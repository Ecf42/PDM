...
export default class App extends React.Component {
  ...
  //   // sabendo que o resultado é uma promise, chame then sobre ela, passando como parâmetro para then, uma função que recebe um parâmetro chamado pics e apenas usa console.log para exibir pics
  //   this.pexelsClient.photos.search({ query: termo }).then(pics => {
  //     console.log(pics)
  ...
  render() {
    return (
      <div className="grid justify-content-center m-auto w-9 border-round border-1 border-400">
        ...
        <div className="col-12 border-1 p-3">
          <div className="grid">
            <ListaImagens
